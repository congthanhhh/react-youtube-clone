        ...
        <div className={`sidebar ${sidebar ? '' : 'small-sidebar'}`}>
            <div className="shortcut-links">
                ...
                <div className={`side-link ${category === 17 ? 'active' : ''}`} onClick={() => setCategory(17)}>
                    <img src={sport} alt="home" /> <p>Sport</p>
                </div>
                <div className={`side-link ${category === 24 ? 'active' : ''}`} onClick={() => setCategory(24)}>
                    <img src={entertaiment} alt="home" /> <p>Entertaiment</p>
                </div>
            ...
            <div className="subscribed-list">
                ...
                <div className="side-link">
                    <img src={jack} alt="subscribe" /> <p>PewDiePie</p>
                </div>
                <div className="side-link">
                    <img src={simon} alt="subscribe" /> <p>MrBeast</p>
                </div>
                <div className="side-link">
                    <img src={tom} alt="subscribe" /> <p>Justin Bieber</p>
                </div>
                <div className="side-link">
                    <img src={megan} alt="subscribe" /> <p>Mixi Gaming</p>
                </div>
                <div className="side-link">
                    <img src={cameron} alt="subscribe" /> <p>Ariana Grande</p>
                </div>
            </div>
        </div>
    );
